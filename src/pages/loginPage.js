...
const LoginPage = () => {
    ...
    return (
        ...
        <div className={s.loginPages}>
            ...
            <img className={s.logiPagedoxImg1} src={eclipseTablet} alt="gfgfg"/>
            <img className={s.logiPagedoxImg2} src={frameTablet} alt="gklg"/>
            </div>
           
        <div className={s.loginPageVrap}></div>
                <img className={s.loginPagesImg} src={frame} alt='кошелек' width='436' height='420'/>
                <h1 className={s.loginPageName}>Finance</h1>
            </div>
